...
button:hover { transform: translateY(-2px); transition: transform 0.2s; box-shadow: 0 5px 20px rgba(0,0,0,0.15) !important; }
div[style*="cursor: pointer"]:hover { transform: scale(1.02); transition: transform 0.3s; }
